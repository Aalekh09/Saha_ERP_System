// Receipt Fix - Override the corrupted generateReceipt function
(function() {
    'use strict';
    
    // Fixed generateReceipt function
    function generateReceiptFixed(payment) {
        console.log('Generating FIXED compact professional receipt for:', payment);

        // Create compact professional receipt HTML with CORRECT symbols
        const receiptHTML = `
            <!DOCTYPE html>
            <html>
            <head>
    ...
    // Override the global generateReceipt function
    if (typeof window !== 'undefined') {
        window.generateReceipt = generateReceiptFixed;
        console.log('✅ Receipt function fixed - symbols corrected, no auto-download');
    }
