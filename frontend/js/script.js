...
async function checkServer() {
    try {
        ...
        const res = await fetch('https://aalekh.sahaedu.in/api/reports/monthly-student-admissions', { method: 'GET' });
...
async function loadReports() {
    try {
        ...
        // Fetch enquiries
        const enquiriesResponse = await fetch('https://aalekh.sahaedu.in/api/enquiries');
